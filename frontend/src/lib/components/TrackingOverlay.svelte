...
<div class="pointer-events-none absolute inset-x-0 z-[700] flex justify-center" style="bottom: {safeBottom};">
	<button
		type="button"
		onclick={onStop}
		class="pointer-events-auto flex items-center gap-2 rounded-full px-6 py-3 shadow-lg transition-colors"
