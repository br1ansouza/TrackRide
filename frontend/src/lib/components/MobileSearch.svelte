...
<div class="absolute inset-x-3 z-[900] flex flex-col gap-3 rounded-xl bg-surface-900/95 p-4 shadow-xl backdrop-blur-sm" style="bottom: calc(60px + env(safe-area-inset-bottom));">
